            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="md:flex items-center gap-3 w-full sm:w-auto">
                            ...
                            <div className="relative w-full sm:w-80">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-yellow-500 outline-none text-sm"
                                />
                            </div>
                                ...
                                currentLogs.map((data, index) => (
                                    ...
                                    <tr key={index} className="hover:bg-gray-50 transition">
                                        ...
                                        <td className="px-6 py-4">
                                            ...
                                            <span className="px-3 py-1 rounded-full text-xs font-medium bg-yellow-50 text-yellow-400">
                                                {data.action}
                                            </span>
                            ...
                            <div key={index} className="p-5 hover:bg-gray-50">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <div>
                                        ...
                                        <span className="inline-flex mt-2 px-3 py-1 rounded-full text-xs font-medium bg-yellow-50 text-yellow-400">
                                            {data.action}
                                        </span>
                ...
                <div className="px-5 sm:px-6 py-5 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="px-4 py-2 rounded-lg bg-yellow-400 text-black text-sm">
